        ...
        <div className='min-h-screen'>
            ...
            <div className='flex flex-col lg:flex-row justify-center mt-36 p-4 ml-12'>
                ...
                <div className='max-w-2xl lg:ml-48'>
                    <h1 className='text-3xl lg:text-5xl font-semibold'>L&apos;extérieur</h1>
            ...
            <div className='flex flex-col lg:flex-row justify-center mt-36 p-4 ml-12'>
                <div className='max-w-xl'>
                    <h1 className='text-3xl lg:text-5xl font-semibold'>Le SPA</h1>
            ...
            <div className='flex flex-col lg:flex-row justify-center mt-36 p-4 ml-12'>
                ...
                <div className='max-w-2xl lg:ml-48'>
                    <h1 className='text-3xl lg:text-5xl font-semibold'>Le séjour & salle à manger</h1>
            ...
            <div className='flex flex-col lg:flex-row justify-center mt-36 p-4 ml-12'>
                <div className='max-w-xl'>
                    <h1 className='text-3xl lg:text-5xl font-semibold'>Les chambres</h1>
