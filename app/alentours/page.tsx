...
export default function alentours() {
    return (
        <div className='min-h-screen'>
            ...
            <h1 className='text-5xl font-semibold tracking-tight text-center pt-24'>Que faire aux alentours de la maison ?</h1>
            ...
            <div className='flex flex-col lg:flex-row justify-center mt-36 p-4 ml-12'>
                ...
                <div className='lg:ml-72 max-w-xl'>
                    <h1 className='text-5xl font-semibold'>Monpazier</h1>
            ...
            <div className='flex flex-col lg:flex-row justify-center mt-36 p-4 ml-12'>
                <div className='max-w-2xl'>
                    <h1 className='text-5xl font-semibold'>Le château de Biron</h1>
            ...
            <div className='flex flex-col lg:flex-row justify-center mt-36 p-4 ml-12'>
                ...
                <div className='lg:ml-72 max-w-xl'>
                    <h1 className='text-5xl font-semibold'>Vallée de la Dordogne</h1>
            ...
            <div className='flex flex-col lg:flex-row justify-center mt-36 p-4 ml-12 pb-48'>
                <div className='max-w-2xl'>
                    <h1 className='text-5xl font-semibold'>Sarlat</h1>
